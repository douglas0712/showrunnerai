...
//
// Este arquivo não importa nada, e é assim que ele deve continuar. Quem traduz
// é o ADAPTADOR do provider, e é ele que aponta para cá:
//
//     comfyJobState.js  ─┐
//     veoJobState.js    ─┼──►  jobStates.js
//     klingJobState.js  ─┘
//
// Nunca o contrário. Um vocabulário genérico que soubesse o nome dos executores
// deixaria de ser genérico no dia do segundo — viraria uma lista de
// `fromIssoState`, `fromAquiloState`, e o domínio cresceria a cada integração.
//
// Acrescentar um provider é acrescentar um arquivo ao lado. Este não muda.
