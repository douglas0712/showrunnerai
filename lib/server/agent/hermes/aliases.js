...
const ALIAS_PARA_CANONICO = Object.freeze({
  ...
  // PASSO 14-E — o som da produção. Um alias por ferramenta, como todas as
  // outras: a tabela é fechada, e é ela que o bridge consulta.
  project_get_scene_narration: 'project.get_scene_narration',
  project_set_scene_narration: 'project.set_scene_narration',
  project_generate_scene_narration: 'project.generate_scene_narration',
  project_list_scene_narration_takes: 'project.list_scene_narration_takes',
  project_select_scene_narration_take: 'project.select_scene_narration_take',
  project_create_scene_sfx_cue: 'project.create_scene_sfx_cue',
  project_update_scene_sfx_cue: 'project.update_scene_sfx_cue',
  project_list_scene_sfx_cues: 'project.list_scene_sfx_cues',
  project_delete_scene_sfx_cue: 'project.delete_scene_sfx_cue',
  project_generate_scene_sfx: 'project.generate_scene_sfx',
  project_list_scene_sfx_takes: 'project.list_scene_sfx_takes',
  project_select_scene_sfx_take: 'project.select_scene_sfx_take',
  project_create_music_cue: 'project.create_music_cue',
  project_update_music_cue: 'project.update_music_cue',
  project_list_music_cues: 'project.list_music_cues',
  project_delete_music_cue: 'project.delete_music_cue',
  project_generate_music: 'project.generate_music',
  project_list_music_takes: 'project.list_music_takes',
  project_select_music_take: 'project.select_music_take',
});
