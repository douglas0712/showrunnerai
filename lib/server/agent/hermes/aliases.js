...
//
// As tools do Showrunner se chamam `og.generate_image`, `og.generate_video`,
// `og.get_job`, `project.list_documents` e `project.read_document`. Esses são os
// nomes canônicos, são os que a UI mostra e são os únicos que o registry
// conhece. Eles não mudam por causa desta integração.
//
