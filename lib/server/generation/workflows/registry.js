...
import { ideogram4T2I } from './ideogram4.js';
import { stableAudioSfx } from './stableAudioSfx.js';
import { aceStep15Music } from './aceStep15Music.js';
 ...
 *
 * Dois workflows reais: MiniMax H3 (vídeo) e Ideogram 4 (imagem). Acrescentar
 * o terceiro é acrescentar um descriptor a esta lista — nenhuma linha da
 * infraestrutura muda, como o Ideogram demonstrou.
 */
...
/** Id do workflow de imagem. */
export const DEFAULT_IMAGE_WORKFLOW_ID = ideogram4T2I.id;
