...
export const generateVideoTool = defineTool({
  ...
  description: 'Gera um vídeo a partir de um prompt textual, opcionalmente animando uma imagem. '
    ...
    + 'Para ANIMAR uma imagem que já existe, informe sourceAssetId — é ele que '
    + 'faz a diferença entre animar aquela imagem e gerar um vídeo do zero.',
  inputSchema: {
    type: 'object',
    properties: {
      prompt: {
      ...
      sourceAssetId: {
        type: 'string',
        description: 'Id de uma imagem já produzida nesta conversa, para ANIMAR. '
          + 'Este campo é o que decide o tipo de geração: '
          + 'AUSENTE gera um vídeo do zero, a partir do texto; '
          + 'PRESENTE anima aquela imagem, e o vídeo fica ligado a ela. '
          + 'Pedidos como "anime essa imagem", "dê movimento a essa foto" ou '
          + '"transforme essa imagem em vídeo" EXIGEM este campo — sem ele o '
          + 'vídeo não tem relação nenhuma com a imagem, por mais que o prompt '
          + 'a descreva. Use um dos identificadores que o sistema informou; '
          + 'nunca invente um. Se não souber a qual imagem o usuário se refere, '
