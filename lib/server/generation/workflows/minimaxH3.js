...
import {
  aspectFromSelector, ASPECT_TO_SELECTOR, selectorForAspect,
...
export const minimaxH3T2V = defineWorkflow({
  ...
  // As proporções que este workflow aceita. Declaradas, e não deduzidas: quem
  // pergunta "esta produção cabe neste gerador?" pergunta ao DESCRIPTOR, e não
  // a uma tabela que ele por acaso importa. É a mesma capacidade que o
  // `ideogram4` já declarava — a ausência aqui era um buraco, não uma decisão.
...
// A tabela de proporções é conhecimento do nó ResolutionSelector, e é
// compartilhada com os outros workflows que usam esse mesmo nó.
export { ASPECT_TO_SELECTOR, aspectFromSelector, selectorForAspect, WorkflowError };
