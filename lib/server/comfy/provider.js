...
export async function submitGeneration(params = {}) {
  const {
    ...
    // sourceAssetId: asset imagem para animar (image-to-video).
    // Requer integração com storage para carregar bytes do asset.
    // Esta etapa apenas aceita o parâmetro; a implementação completa
    // do bridge de i2v é parte do PASSO 7.
    sourceAssetId = null,
  } = params;
