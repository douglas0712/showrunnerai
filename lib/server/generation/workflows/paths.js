...
import { APP_ROOT, appPathWithOverride } from '../../appRoot.js';
 ...
 */
export const PROJECT_WORKFLOWS_ROOT = appPathWithOverride(
  'SHOWRUNNER_WORKFLOWS_ROOT', 'workflows',
);

// Reexportado porque os testes e outros módulos já o consomem daqui; a
// descoberta em si mora em lib/server/appRoot.js.
export { APP_ROOT };
