...
export function normalizeProbe(bruto) {
  ...
  return {
    ...
    // Lista de contêineres que o ffprobe reconheceu, como
    // "mov,mp4,m4a,3gp,3g2,mj2" ou "matroska,webm". É a única forma de saber
    // o que os bytes REALMENTE são: a extensão do arquivo não decide nada.
    formatName: bruto?.format?.format_name || null,
